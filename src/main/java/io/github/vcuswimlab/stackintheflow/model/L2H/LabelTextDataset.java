 ...
 * @author vietan
 */
public class LabelTextDataset extends io.github.vcuswimlab.stackintheflow.model.L2H.TextDataset {
     ...
     * @throws java.lang.Exception
     */
    public void createLabelVocab() {
        logln("--- Creating label vocab ...");
        createLabelVocabByFrequency();
    }

    protected void createLabelVocabByFrequency() {
    ...
    public void inputDocumentInfo(File file) throws Exception {
        ...
        this.inputDocumentInfo(new FileInputStream(file));
    }

	@Override
    public void inputDocumentInfo(InputStream is) throws Exception {
    ...
    public void loadFormattedData(String fFolder) {
        try {
			...
			this.inputLabelVocab(getClass().getResourceAsStream("/" + Paths.get(fFolder, formatFilename + labelVocabExt).toString()));
		} catch (Exception e) {
			e.printStackTrace();
	...
	protected void inputLabelVocab(File file) throws Exception {
		inputLabelVocab(new FileInputStream(file));
    }

    protected void inputLabelVocab(InputStream is) throws Exception {
