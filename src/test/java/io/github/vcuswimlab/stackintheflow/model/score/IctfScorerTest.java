 ...
 */
public class IctfScorerTest {

    private static TermStatComponent termStatComponent;

    private IctfScorer ictfScorer;
    ...
    public void setUp() throws Exception {
        ictfScorer = new IctfScorer(termStatComponent);
    }

    @Test
    public void testScore() throws Exception {
        assertEquals(5.0, ictfScorer.score("term1"), 0.001);
    }

    @Test
    public void testScoreEmpty() throws Exception {
        assertEquals(0.0, ictfScorer.score("term2"), 0.001);
    }
}